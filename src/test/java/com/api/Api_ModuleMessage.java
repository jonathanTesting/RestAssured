...
public class Api_ModuleMessage {
   ...
   @Test
    public void Post_test1() {
        ...
        try {
            for (int i = 1; i < 5; i++) {
                ...
                RestAssured.baseURI = "https://elevadevbackend.azurewebsites.net/api/services/app/ModuleMessage/Create";
                System.out.println("=================================================");
                ...
                RequestSpecification httpRequest = RestAssured.given();
                    ...
                    requestParams.put("moduleId", Math.round(Math.random()*10));
    ...
    public void Post_test2() {
                ...
                RestAssured.baseURI = "https://elevadevbackend.azurewebsites.net/api/services/app/ModuleMessage/Get";
                System.out.println("=================================================");
                System.out.println("La URL a validar:" + RestAssured.baseURI);
                RequestSpecification httpRequest = RestAssured.given();
    ...
    public void Post_test3() {
        ...
        RestAssured.baseURI = "https://elevadevbackend.azurewebsites.net/api/services/app/ModuleMessage/GetAll";
        System.out.println("=================================================");
        System.out.println("La URL a validar:" + RestAssured.baseURI);
        RequestSpecification httpRequest = RestAssured.given();
    ...
    public void PUT_test3() {
                ...
                RestAssured.baseURI = "https://elevadevbackend.azurewebsites.net/api/services/app/ModuleMessage/Update";
                System.out.println("=================================================");
                System.out.println("La URL a validar:" + RestAssured.baseURI);
                RequestSpecification httpRequest = RestAssured.given();
    ...
    public void Delete_test4() {
        ...
        Response response =request.delete("https://elevadevbackend.azurewebsites.net/api/services/app/ModuleMessage/Delete?Id=" +  Math.round(Math.random()*9));
